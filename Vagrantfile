...
Vagrant.configure("2") do |config|
  ...
  config.vm.provider "virtualbox" do |vb|
    vb.name = "vagrant-php-efi_ubuntu2004"
    vb.memory = 1024
...
apt install php8.3 libapache2-mod-php8.3 -q -y

# instala extensões PHP
apt-get install -q -y php8.3-curl php8.3-cli php8.3-common php8.3-mbstring php8.3-xml

a2enmod rewrite headers
systemctl restart apache2

# defini a pasta www_efi como pasta raiz do Apache
dir='/vagrant/www_efi'
